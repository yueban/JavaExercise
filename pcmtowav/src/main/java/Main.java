...
public class Main {
    ...
    private static void rawToWave(final String pcmFileName) {
        File f1 = new File(pcmFileName + ".pcm"); // The location of your PCM file
        System.out.println(f1.getAbsolutePath());
        File f2 = new File(pcmFileName + ".wav"); // The location where you want your WAV file
        try {
            rawToWave(f1, f2);
        } catch (IOException e) {
            e.printStackTrace();
